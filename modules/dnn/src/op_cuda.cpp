...
void registerCudaCommonExecs()
{
    ...
    CV_DNN_REGISTER_EXEC_CLASS(Clip,        DNN_BACKEND_CUDA, CUDALegacyExec);
    ...
    CV_DNN_REGISTER_EXEC_CLASS(Gather2,        DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(ScatterND,      DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(GatherElements, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(GatherND,       DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Scatter,        DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Range,          DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Size,           DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Attention,      DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Arg,            DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Reduce2,        DNN_BACKEND_CUDA, CUDALegacyExec);
    ...
    CV_DNN_REGISTER_EXEC_CLASS(Cast2, DNN_BACKEND_CUDA, CUDALegacyExec);

    CV_DNN_REGISTER_EXEC_CLASS(Convolution, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Deconvolution, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(InnerProduct, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(MatMul, DNN_BACKEND_CUDA, CUDALegacyExec);
    ...
    CV_DNN_REGISTER_EXEC_CLASS(PriorBox, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(PriorBoxClustered, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Region, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Reorg, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(DetectionOutput, DNN_BACKEND_CUDA, CUDALegacyExec);
    ...
    CV_DNN_REGISTER_EXEC_CLASS(LSTM, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(DequantizeLinear, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(QuantizeLinear, DNN_BACKEND_CUDA, CUDALegacyExec);
    ...
    CV_DNN_REGISTER_EXEC_CLASS(ConvTranspose2, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Tile2,          DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Expand2,        DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(ConstantOfShape, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Not,            DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(OneHot,         DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Einsum,         DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(LSTM2,          DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(NonMaxSuppression, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(RoiAlign,       DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(GridSample,     DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(TopK2,          DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(RMSNormalization, DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(CumSum,         DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(CumProd,        DNN_BACKEND_CUDA, CUDALegacyExec);
    CV_DNN_REGISTER_EXEC_CLASS(Trilu,          DNN_BACKEND_CUDA, CUDALegacyExec);
}
