...
if(HAVE_CUDA)
  ...
  if(CUDA_VERSION VERSION_LESS "6.5")
    ...
    if(HAVE_CUDNNJIT)
      set(CPACK_DEB_libs_PACKAGE_DEPENDS "${CPACK_DEB_libs_PACKAGE_DEPENDS}, libcudnn9-cuda-${CUDA_VERSION_MAJOR}")
      set(CPACK_DEB_dev_PACKAGE_DEPENDS "${CPACK_DEB_dev_PACKAGE_DEPENDS}, libcudnn9-dev-cuda-${CUDA_VERSION_MAJOR}")
    endif()
  endif()
  set(CPACK_COMPONENT_dev_DEPENDS libs)
endif()
